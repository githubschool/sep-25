...
1. For the **App name**, enter `my-awesome-book-app`. [:camera:](workshop-images/github-for-managers.036.jpeg)
...
1. Go to the Heroku dashboard at https://dashboard.heroku.com. Select **my-awesome-book-app**. [:camera:](workshop-images/github-for-managers.040.jpeg)
